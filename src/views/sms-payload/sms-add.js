        ...
        <Row gutter={12}>
          ...
          {type === 'mobishastra' && (
            <>
              <Col span={12}>
                <Form.Item
                  label={t('mobishastra_user')}
                  name='mobishastra_user'
                  rules={[
                    {
                      required: true,
                      message: t('required'),
              ...
              <Col span={12}>
                <Form.Item
                  label={t('mobishastra_password')}
                  name='mobishastra_password'
                  rules={[
                    {
                      required: true,
                      message: t('required'),
              ...
              <Col span={12}>
                <Form.Item
                  label={t('mobishastra_sender_id')}
                  name='mobishastra_sender_id'
                  rules={[
                    {
                      required: true,
                      message: t('required'),
