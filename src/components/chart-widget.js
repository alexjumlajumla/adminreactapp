  ...
  options.xaxis = {
    ...
    labels: {
      formatter: function(value) {
        // Handle string date values to prevent duplicates
        return value;
      },
      // Ensure sufficient spacing between labels
      rotateAlways: false,
    ...
    // Improve tick amount to prevent overcrowding
    tickAmount: Math.min(xAxis?.length, 6),
    axisBorder: {
      show: true
    },
    axisTicks: {
